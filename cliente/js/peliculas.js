...
//defino una variable global total_peliculas que me permite manejar el total de peliculas obtenidas de la base de datos
//, se configura en 20 por darle un valor definido.
//total_peliculas se pasará como parametro a la funcion cargarBotones
var total_peliculas=20;
...
function ControladorPeliculas() {
    ...
    this.buscarPeliculas = function(pagina, cantidad) {
            ...
            var query = $.param(query_params); //contiene todos los filtros y lo convierte al formato query params MIO(comentario)
            ...
            $.getJSON(servidor + "/peliculas?" + query,
                function(data) {
                    ...
                    //si la pagina es la 1 entonces actualizo la variable total_peliculas
                    //sino continuo con la cantidad obtenida anteriormente, 
                    //esto me permite que se calcule la cantidad de paginas correctamente.
                    if(pagina_solicitada==1){ 
                        total_peliculas=data.total;
                        self.cargarBotones(total_peliculas);
                    }else{
                        self.cargarBotones(total_peliculas);
                    }
                });
        ...
        this.cargarListado = function(peliculas) {
            ...
            if (cantidad == 0) {
                ...
                cantidad=20; //si se obtuvieron peliculas entonces fijo la cantidad a mostrar en 20 
                for (i = 0; i < cantidad; i++) {
                    ...
                    pelicula.click(function() {
                        ...
                        console.log("se clickeo ID: "+this.id);
                    });
        ...
        this.cargarBotones = function(total) {
            //se establece que se van a mostrar 20 resultados por pagina
